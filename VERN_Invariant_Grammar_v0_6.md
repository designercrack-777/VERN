# VERN Invariant Grammar Specification v0.6
...
FILE_REFERENCE ::= PERIOD IDENTIFIER PERIOD VERN_KW (PERIOD IDENTIFIER PERIOD FOLDER_KW)* (PERIOD PARENT_KW)?
...
FETCH_INSTRUCTION ::= FETCH_KW REFERENCE AS_KW REFERENCE
SEND_INSTRUCTION  ::= SEND_KW REFERENCE TO_KW REFERENCE
