...
; Output: Output\vern_setup_v0.7.8-bugfix.exe

[Setup]
AppId={{8F3A2B1C-4D5E-4F60-9A7B-C1D2E3F40077}
AppName=VERN
AppVersion=0.7.8-bugfix
...
OutputBaseFilename=vern_setup_v0.7.8-bugfix
OutputDir=Output
Compression=lzma
...
MinVersion=10.0
UninstallDisplayName=VERN 0.7.8-bugfix
UninstallDisplayIcon={app}\vern.exe
VersionInfoVersion=0.7.8.1
